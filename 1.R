...
d_train = fread("./cache_data/munged/d_pit_train.csv")
d_valid = fread("./cache_data/munged/d_pit_valid.csv")
d_test = fread("./cache_data/munged/d_pit_test.csv")
...
# Example
# print(d_all_with_pred %>% filter(full_name == "Chris Sale"))
