...
# Paths
dir_local = "C:/Users/wei/Desktop/Moneyball/data/cache_data/lahman/"
dir()
#dir_github = "https://github.com/chadwickbureau/baseballdatabank/raw/master/core/"
dir_github = "C:/Users/wei/Desktop/Moneyball/baseballdatabank-master/core/"
...
if (TRUE) {
  ...
  d_pit = d_pit[IPouts > filter_IPouts & debut_year >= 1970]
  ...
  reformat_pit = function(d_pit, list_pit, targets,
    ...
    if (length(unique(tmp_pit$yearID)) > 1) {
      ...
      tmp_pit_agg[, FIP := ((((13 * HR) + (3*(BB + HBP)) - (2*SO))/(IPouts / 3))+3.2), by = .I]
  ...
  if (save_csv) {
    fwrite(d_pit_train, file = "C:/Users/wei/Desktop/Moneyball/data2/d_pit_train2.csv")
    fwrite(d_pit_valid, file = "C:/Users/wei/Desktop/Moneyball/data2/d_pit_valid2.csv")
    fwrite(d_pit_test, file = "C:/Users/wei/Desktop/Moneyball/data2/d_pit_test2.csv")
  }
...
if (TRUE) {
  ...
  reformat_bat = function(d_bat, list_bat, targets,
    ...
    if (length(unique(tmp_bat$yearID)) > 1) {
      ...
      #WOBA
      tmp_bat_agg[, WOBA := (0.691*BB + 0.722*HBP + 0.884*(H-H2B-H3B-HR) + 1.257*H2B + 1.593*H3B + 2.058*HR) / (AB + BB -IBB + SF +HBP), by = .I]
  ...
  # Save reformatted datasets as cache
  if (save_csv) {
    fwrite(d_bat_train, file = "C:/Users/wei/Desktop/Moneyball/data2/d_bat_train.csv")
    fwrite(d_bat_valid, file = "C:/Users/wei/Desktop/Moneyball/data2/d_bat_valid.csv")
    fwrite(d_bat_test, file = "C:/Users/wei/Desktop/Moneyball/data2/d_bat_test.csv")
  }
