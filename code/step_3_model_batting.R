...
d_train = fread("C:/Users/wei/Desktop/Moneyball/data2/d_bat_train.csv")
d_valid = fread("C:/Users/wei/Desktop/Moneyball/data2/d_bat_valid.csv")
d_test = fread("C:/Users/wei/Desktop/Moneyball/data2/d_bat_test.csv")
...
# Output Example
View(d_all_with_pred %>% filter(full_name == "Mike Trout"))
#write.table(d_all_with_pred,file="C:/Users/wei/Desktop/Moneyball/data2/d_all_with_pred.csv",sep=",",row.names=T, na = "NA")
