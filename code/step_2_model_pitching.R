...
d_train = fread("C:/Users/wei/Desktop/Moneyball/data2/d_pit_train2.csv")
d_valid = fread("C:/Users/wei/Desktop/Moneyball/data2/d_pit_valid2.csv")
d_test = fread("C:/Users/wei/Desktop/Moneyball/data2/d_pit_test2.csv")
#View(d_train)
...
# Targets (looks at three main metrics for pitching)
targets = c("ERA",
            "BAOpp",
            "WHIP",
            "FIP")
...
for (n_target in 1:length(targets)) {
  ...
  # Filter
  d_train = copy(d_all[yearID >= 1970 & yearID <= 2015])
...
View(d_all_with_pred)

# Example
View(d_all_with_pred %>% filter(full_name == "Dallas Keuchel"))
